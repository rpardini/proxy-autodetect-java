...
// --------------------- Interface ScriptMethods ---------------------
     ...
     * @param year1  is the full year number, for example 1995 (but not 95).
     *               Integer.
     ...
     * @param year2  is the full year number, for example 1995 (but not 95).
     *               Integer.
     ...
     *
     * @param host    a DNS host name, or IP address. If a host name is passed, it
...
// -------------------------- OTHER METHODS --------------------------
     ...
     * time based methods.
     *
     * @param useGmt flag to indicate if the calendar is to be created in GMT time
     *               or local time.
     ...
     * map.
     *
     * @param params a map to put the parsed parameters into.
     * @param value  to parse and specify the type for.
     *               **********************************************************************
     */
